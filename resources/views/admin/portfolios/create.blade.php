...
<div class="bg-white rounded-xl shadow-lg p-6">
    <div class="flex items-center mb-6">
        ...
        <h2 class="text-xl font-semibold text-gray-800">Tambah Portfolio Baru</h2>
    </div>
            ...
            <div class="md:col-span-2">
                ...
                <div id="uploadArea" class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-brand-green transition-colors cursor-pointer">
                    <div class="space-y-1 text-center">
                        ...
                        <div id="loadingSpinner" class="hidden mx-auto h-12 w-12">
                ...
                <!-- Drag & Drop Overlay -->
                <div id="dragOverlay" class="hidden absolute inset-0 bg-brand-green bg-opacity-20 border-2 border-brand-green border-dashed rounded-lg flex items-center justify-center">
                    <div class="text-center">
                        <svg class="mx-auto h-12 w-12 text-brand-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
                        </svg>
                        <p class="text-brand-green font-medium">Lepaskan gambar di sini</p>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showLoading() {
        ...
        uploadText.textContent = 'Memproses gambar...';
    }
    ...
    function showImagePreview(file) {
        ...
        reader.onload = function(e) {
            setTimeout(() => { // Small delay to show loading effect
